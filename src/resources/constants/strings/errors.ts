...
export const FIND_USER_OR_COMPONENT_ERROR = "User or component does not exist";
...
export const FIND_COMPONENT_DETAILS_VERSION_ID_ERROR = "Component details with this id do not exist";
export const TEAM_MEMBER_ALREADY_ASSIGNED_ERROR = "This user is already assigned to this project/component";
